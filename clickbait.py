"""Генератор кликбейтных заголовков со скучным контентом"""
import random
...
STATES = ['California', 'Texas', 'Florida', 'New York', 
          'Pensylvania', 'Illinois', 'Ohio', 'Georgia', 
          'North Carolina', 'Michigan']
NOUNS = ['Athlete', 'Clown', 'Shovel', 'Paleo Diet', 
         'Doctor', 'Parent', 'Cat', 'Dog', 'Chicken', 'Robot', 
...
def main():
    ...
    print('By Al Sweigard at@inventwithpython.com')
    print()
    
    print('Our website needsto trick people into looking at ads!')
    while True:
        ...
        if not response.isdecimal():
            ...
            break # выход из цикла когда юзер ввел допустимое число
...
# если программа не импортируется а запускается
